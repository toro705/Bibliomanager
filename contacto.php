<?php
	...
	// Configuración de la página
 	...
 	$metas = array(
		...
		'titulo' 		=> $txt['contacto_metas'][0],

		'descripcion' 	=> $txt['contacto_metas'][1],

		'img' 			=> '',

		'slider' 		=> $txt['contacto_metas'][2]
					...
					<div class="col-xs-12 col-lg-8 col-lg-offset-2">
						...
						<form id="contact-form" class="form-horizontal" role="form" method="post">
						  <div class="form-group text-left">
							    <label for="nombre" class="col-md-3 control-label paragraph-3"><?=$txt['contacto'][1] ?></label>
							    <div class="col-md-9">
							      <input type="nombre" class="form-control" id="nombre" name="nombre" value="<?= (isset($_POST['nombre'])) ? $_POST['nombre'] : ''; ?>" placeholder="">
							    </div>
						  </div>
						  <div class="form-group text-left">
							    <label for="empresa" class="col-md-3 control-label paragraph-3"><?=$txt['contacto'][2] ?></label>
							    <div class="col-md-9">
						  ...
						  <div class="form-group text-left">
							    <label for="telefono" class="col-md-3 control-label paragraph-3"><?=$txt['contacto'][3] ?></label>
							    <div class="col-md-9">
							      <input type="number" class="form-control" id="telefono" name="telefono" <?= (isset($_POST['telefono'])) ? $_POST['telefono'] : ''; ?>" placeholder="">
							    </div>
						  </div>
						  <div class="form-group text-left">
							    <label for="pais" class="col-md-3 control-label paragraph-3"><?=$txt['contacto'][4] ?></label>
							    <div class="col-md-9">
							      <input type="text" class="form-control" id="pais" name="pais" value="<?= (isset($_POST['pais'])) ? $_POST['pais'] : ''; ?>" placeholder="">
							    </div>
						  </div>
						  <div class="form-group text-left">
							    <label for="motivo" class="col-md-3 control-label paragraph-3"><?=$txt['contacto'][5] ?></label>
							    <div class="col-md-9">
							      <input type="text" class="form-control" id="motivo" name="motivo" value="<?= (isset($_POST['motivo'])) ? $_POST['motivo'] : ''; ?>" placeholder="">
							    </div>
						  </div>
						  <div class="form-group text-left">
							    <label for="como_conocio" class="col-md-3 control-label paragraph-3"><?=$txt['contacto'][6] ?></label>
							    <div class="col-md-9">
						    		<div class="select icono">
										<select class="form-control" name="como_conocio" id="como_conocio" value="<?= (isset($_POST['como_conocio'])) ? $_POST['como_conocio'] : ''; ?>">
											...
											<option value="Vía Pública"><?=$txt['contacto'][7] ?></option>
										</select>
						    		</div>
							    </div>
						  </div>
						  <div class="form-group text-left">
							    <label for="comentarios" class="col-md-3 control-label paragraph-3"><?=$txt['contacto'][8] ?></label>
							    <div class="col-md-9">
						  ...
						  <div class="form-group">
						    <div class="col-xs-12 col-md-9 col-md-offset-3 text-center">
						      <button type="submit" class="btn btn-rojo" name="enviar_contacto"><?=$txt['gral'][6] ?></button>
						    </div>
						  </div>
						</form>
						<?php } ?>
