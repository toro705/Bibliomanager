...
Class Input_captcha extends Campo{
	...
	public $site_key	= '6LdX8w0UAAAAABbD4j03XrswJ6u7CVbHCeHToL-v';
	public $secret_key 	= '6LdX8w0UAAAAAKS6o-QIc3d0sAWnZ4BCvMLFsik_';

	function __construct( $datos ){

		parent::__construct( $datos );

		$this->site_key 	= $this->site_key==''   ?  '6LecaAgUAAAAAMcVTnXqouffOPhBBrZ1IdXS_eOO' : $this->site_key;
		$this->secret_key 	= $this->secret_key=='' ?  '6LecaAgUAAAAAHtk-LXY9-2oeLziQDXr96VRwUla' : $this->secret_key;
