          ...
          <div class="col-xs-12 col-sm-9 col-md-8">
              ...
              ">
                  ...
                  <ul class="list-inline list-unstyled pull-right">
                    ...
                    <li><a href="<?=url('bmg')?>">BMG</a></li>

                    <li><a href="<?=url('contacto')?>"><?=$txt['nav'][0] ?></i></a></li>
            ...
            <div id="cabecera-navbar-collapse" class="navbar-collapse collapse js-navbar-cabecera bg-2">
              ...
              <nav class="nav-principal anim-suave">
                ...
                <ul>
                  ...
                  <li class="visible-xs"><a href="<?=url('home')?>"><small><i class="fa fa-home" aria-hidden="true"></i></small></a></li>
                  <li class="visible-xs"><a href="<?=url('bmg')?>"><b><small>BMG</small></b></a></li>
                  <li class="visible-xs"><a href="<?=url('contacto')?>"><b><small><?=$txt['nav'][0] ?></small></b></a></li>
                 ...
                 <!--  <li class="dropdown visible-xs">
                  ...
                  <li><a href="<?=url('editoriales')?>"><b><?=$txt['nav'][1] ?></b></a></li>

                  <li><a href="<?=url('librerias')?>"><b><?=$txt['nav'][2] ?></b></a></li>

                  <li><a href="<?=url('distribuidores')?>"><b><?=$txt['nav'][3] ?></b></a></li>

                  <li><a href="<?=url('seapartner')?>"><b><?=$txt['nav'][4] ?></b></a></li>

                  <li><a href="<?=url('redglobal')?>"><b><?=$txt['nav'][5] ?></b></a></li>
